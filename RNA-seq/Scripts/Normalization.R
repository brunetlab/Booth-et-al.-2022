...
pData(eset)$group <- factor(paste(pData(eset)$Sex, pData(eset)$Days.with.Males, pData(eset)$Presence.of.males, pData(eset)$Age, sep = "_"))
...
## Including only Day 3 samples for DESeq2 comparison
eset.day3 <- eset[, c(3:9, 26:32)]
...
## Including only Day 7 samples for DESeq2 comparison
eset.day7 <- eset[, c(10:17, 22:25, 33:40)]
